...
$sql = $con->prepare("SELECT PR.idproducto, PR.nombre, PR.descripcion, PR.precio, PR.idcategoria, PR.imagen, CT.categoria FROM productos as PR INNER JOIN categorias as CT ON CT.idcategoria = PR.idcategoria WHERE activo = 1 AND PR.idcategoria = 5 LIMIT  5 ");
$sql->execute();
        ...
        <div class="col-md-3">
            <main class="grid">
                <article>
                    <?php
                    $id = $row['idproducto'];
                    $dir = "http://localhost:8080/Aton_1_7/assets/img/Torre/" .$id;
                    /*if(!is_dir($dir)){
                        mkdir($dir);
                    }*/         
