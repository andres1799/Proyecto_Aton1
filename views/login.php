          ...
          <div class="align-self-center w-100 px-lg-5 py-lg-4 p-4">
            ...
            <form class="mb-5" action="" method="post">
              ...
              <div class="mb-4">
                ...
                <input type="password" class="form-control bg-dark-x border-0 mb-2" name="clave" placeholder="Ingresa tu contraseña" id="exampleInputPassword1">
              ...
              <button type="submit" name="active" class="btn btn-light w-100">Iniciar sesión</button>
