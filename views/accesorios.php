...
$sql = $con->prepare("SELECT PR.idproducto, PR.nombre, PR.descripcion, PR.precio, PR.idcategoria, PR.imagen, CT.categoria FROM productos as PR INNER JOIN categorias as CT ON CT.idcategoria = PR.idcategoria WHERE activo = 1 AND PR.idcategoria = 4 LIMIT  5 ");
$sql->execute();
